// calls get_or() on the future to return a custom string if
// exception is set in future
...
int main()
{
	...
	// get_or() returns parameter if future contains an exception
	std::cout << f.get_or("Something went wrong");
}
